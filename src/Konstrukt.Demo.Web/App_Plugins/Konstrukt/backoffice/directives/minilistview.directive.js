...
(function () {
    ...
    function konstruktMiniListView($routeParams, $injector, $timeout, listViewHelper) {
        ...
        var directive = {
            restrict: 'E',
            replace: true,
            templateUrl: '/App_Plugins/Konstrukt/backoffice/directives/minilistview.html',
            scope: {
                opts: '=options',
                onGetItems: '=',
                onSelectItem: '=',
    ...
    angular.module("umbraco.directives").directive("konstruktMiniListView", konstruktMiniListView);
